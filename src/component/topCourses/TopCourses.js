        ...
        <div>
            <div className='container mt-5'>
                <div className='d-flex justify-content-between'>
                    <div className=''>
                        <p className='p-2 m-0 custom-font-family fw-semibold course-heading text-uppercase'>top courses</p>
                    </div>

                    <div className='d-flex gap-3'>
                        <div className='bg-light p-2 rounded fw-medium course-text '>
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-chevron-left" viewBox="0 0 16 16">
                                <path fill-rule="evenodd" d="M11.354 1.646a.5.5 0 0 1 0 .708L5.707 8l5.647 5.646a.5.5 0 0 1-.708.708l-6-6a.5.5 0 0 1 0-.708l6-6a.5.5 0 0 1 .708 0" />
                            </svg>
                        </div>
                        <div className='bg-light p-2 rounded fw-medium course-text text-capitalize'>
